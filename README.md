[![Build status](https://ci.appveyor.com/api/projects/status/uvnyjpe1voo3onlu/branch/master?svg=true)](https://ci.appveyor.com/project/maria-namira/lifecycle-http-watches/branch/master)

### Deployment:  <a href="https://maria-namira/lifecycle-http-watches/branch/master/">Github Pages</a>
